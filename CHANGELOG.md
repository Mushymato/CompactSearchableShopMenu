...
- Minecart menu item per row is now configurable
- The title is now split by ` - ` which should usually be a little more readable

## [1.2.0] - 2026-03-15

### Added

- You can now show minecart menu as a shop.

## [1.1.1] - 2026-03-14

### Fixed

- Stack number should not draw when full name is shown.

## [1.1.0] - 2026-02-10

### Added

- Config to always show item display name.

## [1.0.1] - 2025-10-18

### Fixed

- Bug where the custom tabs for QiGemShop and LostItems do nothing.
